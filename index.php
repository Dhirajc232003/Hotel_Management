...
<html>
	...
	<body style="background: #f2f2f2;">
		...
		<h1>THE <p style="color: #e6b800; display: inline;">ELITE</p> HOTEL</h1>
		...
		<a class="reserve_room" href="image_gallery.php">OUR ROOMS</a><br>
		...
		<div id="contact" class="footer">
			...
			<h3 class="foot-text">Developers: XYZ</h3><br>
			<h3 class="foot-text">Owner: XYZ</h3><br>
		</div>
	</body>
</html>