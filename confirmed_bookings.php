	...
	<div style="margin-left:25%;padding:1px 16px;height:1000px;">
		<p style="margin-left: 10%; margin-top: 5%; font-size: 28px;"></p>
			<table class="basic_box">
				<tr>
					<td id="co" colspan="6"><p style="font-size: 28px; text-align: center; text-decoration: underline;"><b>Confirmed Bookings</b></p>
				</td>
				<tr>
					<th id="co">Booking ID</th>
					<th id="co">Name</th>
					<th id="co">Room Type</th>
					<th id="co">Check-in Date</th>
					<th id="co">Check-out Date</th>
					<th id="co">Price</th>
				</tr>
				<tr>
				<?php
			...
			<table class="basic_box">
				<tr>
					<th id="co" colspan="2">Modify Stay</th>
				</tr>
				<tr><td><br></td></tr>
				<tr>
					<td id="co" colspan="1">Enter Booking ID:</td>
					<td id="co" colspan="2">
				...
				<tr>
					<td id="co" colspan="1">Enter new CheckOut date:</td>
					<td colspan="2">
